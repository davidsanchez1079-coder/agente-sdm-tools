...
create table public.messages (
  ...
  mode_used text not null check (mode_used in ('general','sandvik','vargus','korloy','dormer','boehlerit')),
...
create table public.agent_queries (
  ...
  mode text not null check (mode in ('general','sandvik','vargus','korloy','dormer','boehlerit')),
